          ...
          <tbody>
            {data.data.map((item, index) => (
              <tr
                ...
                onClick={() => loadProductKey(item.Id)}
              >
        ...
        <Modal.Body>
          <div className="text-center w-full max-w-md">
            <h3 className="mb-5 text-3xl font-bold text-gray-900">
              {productKey !== undefined ? productKey.Key : ""}
            </h3>
            <h4 className="mb-5 text-2xl font-semibold text-gray-700 dark:text-gray-400">
              {productKey !== undefined ? productKey.HotelName : ""}
            </h4>
            <center>
              <Button
                onClick={() =>
                  copyToClipboard(
                    `${productKey?.HotelName}\n${productKey?.Key}`,
                  )
                }
              >
                Copy Key
            ...
            <div className="my-4">
              {copySuccess.startsWith("Failed") ? (
                <p className="text-[#E21111]">{copySuccess}</p>
              ) : (
                <p className="text-[#62B532]">{copySuccess}</p>
              )}
            </div>
          </div>
        </Modal.Body>
