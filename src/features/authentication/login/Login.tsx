...
export const Login = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (isError) {
                toast.error(`Failed to log in: ${err.data.detail}`)
            }
        }
    }
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form action="#" method="POST" className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        >
                            {isLoading ? <svg aria-hidden="true" className="inline w-5 h-5 text-gray-200 animate-spin fill-gray-200 mx-2" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
